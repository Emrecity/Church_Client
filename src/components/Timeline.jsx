...
const Timeline = () => {
    const data =[{position:'Agent-in-charge',name:'Cat. Augustine K. Arthur'},{position:'Senior Presbyeter',name:'Mr. Joseph Owusu Agymang'},{positon:'Session Clerk',name:'Samuel Baffour Appiah'}]
  return (
